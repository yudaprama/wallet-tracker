    ...
    <li>
      <a href="#usage">Usage</a>
         <ul>
           ...
           <li><a href="#track-top-token-holders">Track Top Token Holders</a></li>
           <li><a href="#store-token-balance-snapshots">Store Token Balance Snapshots</a></li>
           <li><a href="#compare-token-balance-snapshots">Compare Token Balance Snapshots</a></li>
...
If you want to fetch the top 20 holders of an ERC-20 token on Ethereum, set your `ETHERSCAN_API_KEY` first and use:

```shell
   $ export ETHERSCAN_API_KEY=your_api_key
   $ wallet-tracker tracker token-holders --contract 0x17205fab260a7a6383a81452cE6315A39370Db97 --limit 20
```

If you prefer JSON output:

```shell
   $ wallet-tracker tracker token-holders --contract 0x17205fab260a7a6383a81452cE6315A39370Db97 --limit 20 --format json
```

### Store Token Balance Snapshots

If you want to persist balance snapshots for a list of token holders into SQLite:

```shell
   $ wallet-tracker tracker token-snapshot --contract 0x17205fab260a7a6383a81452cE6315A39370Db97 --addresses "0xabc 0xdef" --db data/token-tracker.sqlite
```

### Compare Token Balance Snapshots

If you want to compare the latest two stored snapshots and see increases or decreases:

```shell
   $ wallet-tracker tracker token-diff --contract 0x17205fab260a7a6383a81452cE6315A39370Db97 --db data/token-tracker.sqlite --direction all
```
